...
void loop()
{
  ...
  // spotify.save_current_album_image(cover_url, image_data);
  
  // if(!saveToSPIFFS("/current_cover.jpg", image_data)){
  //   Serial.println("Failed to save image data to SPIFFS");
  // } 
  // else {
  //   Serial.println("Image data saved to SPIFFS successfully");
  // } // Save the image data to SPIFFS

  // sendImageSerial("/current_cover.jpg"); // Send the image data to Serial for debugging

  // delay(10000); // Delay for 1 second before checking again
}
